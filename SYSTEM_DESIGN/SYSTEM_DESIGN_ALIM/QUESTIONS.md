[Reference](https://github.com/prasadgujar/low-level-design-primer/tree/master)
...
- Design Maps Navigator Client for different transportation types
 ...
 - Design Meeting Scheduler
    ...
    - You should use calendar for tracking date and time. And also history of all the meetings which are booked and meeting room.
...
- Design an electronic signature system like DocuSign / EasySign.
...
- Designing an ID card system which employees use to access any zone/premises.
