...
print("----------Built in decorator @dataclass with parameter----------")
...
# Comparison using the ordering methods generated by 'order=True'
print(student1 > student2)
# Attempt to modify a frozen instance (will raise an error)
try:
    student1.student_roll = 3
